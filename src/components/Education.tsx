  ...
  const education = [
    {
      ...
      gpa: "3.66 CGPA",
      highlights: [
        "Graduated with profound knowledge and skills in computer science",
        "Senior Project: Online Bidding System (MERN Stack)",
        "Key Courses: Algorithms, AI, Embedded Systems, Web Development",
      ],
    },
    {
      icon: <FaSchool className="text-2xl" />,
      degree: "LEVEL II FOR BASIC ELECTRONICS COMMUNICATION AND MULTIMEDIA EQUIPMENT MAINTENANCE SERVICE",
      institution: "GYM Technology Institute, Bahir Dar",
      year: "2021 - 2022",
      highlights: [
        "troubleshooting electronic circuits",
        "maintaining communication and multimedia equipment",
        "assembling and testing electronic devices",
      ],
    },
  ];
